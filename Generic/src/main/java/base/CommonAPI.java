...
public class CommonAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("Windows 10") String os, @Optional("10.0") String os_version, @Optional("chrome-options") String browserName, @Optional("34")
                                  String browserVersion, @Optional("https://www.ulta.com/") String url) throws IOException {
...
//        System.setProperty("webdriver.chrome.driver", "/Users/jewal/IntelliJ/WebAutomationGroup3/Generic/browser-driver/chromedriver");
    ...
    public WebDriver getLocalDriver(@Optional("windows 10") String OS, String browserName) {
